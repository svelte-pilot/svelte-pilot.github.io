<script lang='ts' module>
  import { Link, type LoadFunction, setLinkOptions, View } from 'svelte-pilot'
...
<script lang='ts'>
  ...
  let { headings, nextSection, prevSection } = $derived.by(() => {
    ...
    return { headings, nextSection, prevSection, sections }
  })
...
<div class='flex md:w-fit md:mx-auto'>
  ...
  <main class='max-w-3xl min-w-0 p-4 sm:p-6 md:p-8'>
    <div class='mb-4 flex justify-between'>
      <div>
        <a href='#toc' aria-hidden='true' class='lg:hidden'>
          <svg
