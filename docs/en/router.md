...
5. Call the `beforeEnter` event handler exported in the `<script module>` of synchronously loaded Svelte components.
6. Call the `beforeEnter` event handler exported in the `<script module>` of asynchronously loaded Svelte components.
